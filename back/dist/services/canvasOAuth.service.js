...
exports.getValidTokenForUser = getValidTokenForUser;
const types_1 = require("../models/types");
const tokenStorage_service_1 = require("./tokenStorage.service");
/**
...
async function exchangeCodeForToken(code) {
    ...
    if (tokenData.refresh_token && tokenData.user) {
        await (0, tokenStorage_service_1.saveRefreshToken)(tokenData.user.id.toString(), tokenData.refresh_token);
    }
    return tokenData;
}
/**
...
async function getValidTokenForUser(userId) {
    const storedRefreshToken = await (0, tokenStorage_service_1.getRefreshToken)(userId);
...
//# sourceMappingURL=canvasOAuth.service.js.map