 ...
 */
async function canvasProxy(request, context) {
 ...
 */
async function fetchAllPages(initialUrl, accessToken, context) {
    const allResults = [];
 ...
 */
async function fetchFromCanvas(url, options, retries = 3) {
...
functions_1.app.http('canvasProxy', {
    methods: ['GET', 'POST', 'PUT', 'DELETE'],
    route: 'canvas/{*path}',
    authLevel: 'anonymous',
    handler: canvasProxy,
});
//# sourceMappingURL=canvasProxy.js.map